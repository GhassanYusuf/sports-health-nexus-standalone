// Delete a member and their auth user securely
// - Validates the caller is admin/super_admin
// - Deletes auth user with service role key (cascades to profile)
...
serve(async (req) => {
  ...
  try {
    ...
    // Delete user with admin privileges (cascades to profile)
